...
const ThreeGhost = dynamic(() => import("./live/ThreeGhost"), { ssr: false });
...
export default function LiveTracker() {
    ...
    }, [autoFeedback, triggerEdgeAudio, triggerParticles, maxJump, coachLanguage, handedness, ballDetected, triggerProactiveCoaching, setDrillScore, analyzeShotWithGemini, isAnalyzingShot]);
        ...
        try {
            ...
            if (user) {
                const { error: dbError } = await supabase.from("sessions").insert({
                    ...
                    avg_score: Math.round(emaRef.current.score),
                    avg_stability: Math.round(emaRef.current.stability),
                    avg_explosivity: Math.round(emaRef.current.explosivity),
